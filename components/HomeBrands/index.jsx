  ...
  return (
    <section className="group">
      <ul className={styles.brands}>
        <li>
          <Link href="/portfolio/ihg-business-advantage">
            <a className={styles.brand_ihg}>IHG</a>
          </Link>
        </li>
        <li>
          <Link href="/portfolio/vodafone-free-sim">
            <a className={styles.brand_vodafone}>Vodafone UK</a>
          </Link>
        </li>
        <li>
          <Link href="/portfolio/battersea-looking-for-you">
            <a className={styles.brand_battersea}>Battersea Dogs &amp; Cats Home</a>
          </Link>
        </li>
        <li>
          <Link href="/portfolio/huawei-run-impossible">
            <a className={styles.brand_huawei}>Huawei</a>
          </Link>
        </li>
        <li>
          <Link href="/portfolio/chet-atkins-all-wah">
            <a className={styles.brand_converse}>Converse</a>
          </Link>
        </li>
        <li>
          <Link href="/portfolio/jd-track-mat-dock">
