    ...
    <LayoutCaseStudy caseStudy={caseStudy}>
      ...
      <section className="group">
        ...
        <figure className="layout-captioned">
          ...
          <div className="layout-captioned--content">
            <img src="/static/images/caseStudies/jd-roots/age-gate/1024.png" alt="Age gate" />
          </div>
        </figure>
      </section>
      ...
      <section className="group-alternate">
        <figure className="layout-captioned">
          ...
          <div className="layout-captioned--content">
            <img src="/static/images/caseStudies/jd-roots/homepage/home-1200.jpg" alt="Age gate" />
          </div>
        </figure>
      </section>
      ...
      <section className="group">
        <figure className="layout-captioned">
          ...
          <div className="layout-captioned--content">
            <img src="/static/images/caseStudies/jd-roots/homepage/horrors-1370.jpg" alt="Age gate" />
          </div>
        </figure>
        ...
        <figure className="layout-captioned">
          ...
          <div className="layout-captioned--content">
            <img src="/static/images/caseStudies/jd-roots/homepage/cribs-1200.jpg" alt="Age gate" />
          </div>
        </figure>
      </section>
